...
public class Demo {
        public static void main(String[] args) {
                ...
                Book b1 = new Book("The Running Room", 1234, a1, "Books Inc.", 4);
                Book b2 = new Book("Fishing Fun", 5678, a2, "Books Inc.", 5);
                Book b3 = new Book("Along Came A Spider", 9112, a3, "Random Inc.", 10);
                Book b4 = new Book("The Helping Hand", 3456, a2, "Random Inc.", 20);
                ...
                System.out.println();
                System.out.println(
                                "I can find any information about the books, authors, or patrons... (i.e. GET methods)");
                System.out.println();
                ...
                System.out.println("Search for James Cantwell: "
                                + library.searchByAuthor(new Author("James Cantwell", null)));
                ...
                System.out.println();
                System.out.println(
                                "Patron 1 (" + p1.getFname() + " " + p1.getLname()
                                                + ") will borrow the following book: " + b1);
                ...
                System.out.println();
                System.out.println(
                                "As you can see, there is only one copy of The Running Room that was borrowed, not two.");
                ...
                System.out.println();
                System.out.println("Now, I will demonstrate REMOVING an author from the library.");
                System.out.println();
                System.err.println(library);
                library.removeBook(b2); // should remove Fishing Fun.
                System.out.println();
                System.out.println(
                                "As you can see below, Fishing Fun was successfully removed. It was also removed from Patrick Hann's book list.");
                System.out.println();
                System.out.println("Patrick Hann's Book List: " + a2.getBooksList());
                System.out.println();
                System.out.println("LIBRARY: \n\n" + library);
                System.out.println();
                System.out.println(
                                "Now I will REMOVE AN AUTHOR from the library... Remove Patrick Hann... This will also remove all the books he has written (i.e. The Helping Hand).");
                library.removeAuthor(a2); // should remove Patrick Hann from the library.
                System.out.println();
                System.out.println(library);
                System.out.println();

                System.out.println("REMOVING A PATRON from the library... Remove Jack Crawford.");
                library.removePatron(p2); // should remove Jack Crawford.
                System.out.println();
                System.out.println(library);
                System.out.println();
        }
